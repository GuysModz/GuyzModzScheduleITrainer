-- ===================================================================
-- KETAMINEUI LIBRARY – FIXED WITH BIGGER SIZE & HORIZONTAL SCROLL
-- ===================================================================
local Library = {}
...
function Library:CreateWindow(config)
    ...
    local windowSize = config.Size or UDim2.new(0, 450, 0, 550) -- BIGGER
...
-- ===================================================================
-- END OF LIBRARY – NOW COPY YOUR SCRIPT BODY BELOW
-- ===================================================================
